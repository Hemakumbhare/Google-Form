 ...
 */}
                            ...
                            {ques.options.map((op, j)=>(
                               ...
                               {/* <Button size="small"  onClick={()=>{addAnswer(i)}} style={{textTransform: 'none',color:"#4285f4",fontSize:"13px",fontWeight:"600"}}>       <ArrowDropUpIcon style={{border:"2px solid #4285f4", padding:"2px",marginRight:"8px"}} /> Answer key</Button> */}
...
<div >
    ...
    {ques.options.map((op, j)=>(
        ...
        <div className="add_question_body">
            ...
            <Button size="small"  style={{textTransform: 'none',color:"#4285f4",fontSize:"13px",fontWeight:"600"}}> <ShortTextIcon style={{fontSize:"20px",marginRight:"8px"}}/>Add Answer Feedback</Button>
